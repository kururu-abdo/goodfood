...
class MachineListMeintance extends StatefulWidget {
  final  int? branchId;
  const MachineListMeintance({ Key? key, this.branchId }) : super(key: key);

  @override
  _MachineListMeintanceState createState() => _MachineListMeintanceState();
}

class _MachineListMeintanceState extends State<MachineListMeintance> {
  ...
  var controller = Provider.of<MaintenanceController>(context);
    ...
    return Scaffold(
      ...
      appBar: mLightAppBar(context,
       translate(context, "branch_assets") ,
...
IconButton(onPressed: (){
  controller.getBranchAssets(context , 1.toString());
}, icon:  Icon(
...
Center(
 ...
 ListView.builder(
  ...
  itemBuilder: (BuildContext context, int index) {
        var branchData = controller.branchAssets!.data![index];
      ...
      offset: Offset(0.0, 3.0),
        ...
        // )
         ...
         Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
branchData.imgUrl ==null?
  Image.asset("assets/icon/machine.png"
         ,color: Colors.white,
         
         height: 80,width: 80,
         
         ):
  Image.network('https://goodfoodsa.co${branchData.imgUrl}'
        ,
...
const SizedBox(height: 8,),
              Text(
            "Last Maintenace Date: ${branchData.lastMaintain}"  ,
            style: const TextStyle(
              // color: Colors.white ,
