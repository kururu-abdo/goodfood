...
class OtherAssetsPage extends StatefulWidget {
  const OtherAssetsPage({ Key? key }) : super(key: key);

  @override
  _OtherAssetsListMeintanceState createState() => _OtherAssetsListMeintanceState();
}

class _OtherAssetsListMeintanceState extends State<OtherAssetsPage> {
