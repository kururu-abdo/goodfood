...
class NotificationFilterBottomsheet extends StatefulWidget {
  ...
  const NotificationFilterBottomsheet({ Key? key, this.isMaintain = false }) : super(key: key);

  @override
  _FilterBottomSheetState createState() => _FilterBottomSheetState();
}

class _FilterBottomSheetState extends State<NotificationFilterBottomsheet> 
...
DateTime? _endDate;
  ...
  Widget build(BuildContext context) {
    var maintenanceController = Provider.of<NotificationController>(context);
    return Container(
